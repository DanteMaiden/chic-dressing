				...
				<div class="cv-inner">
					<div class="slider-info">
						...
						if ( $repeater_item->btn_text === '' && $repeater_item->link !== '' ) {
							echo '<a title="Informations" class="slider-image-link" href="'. esc_url( $repeater_item->link ) .'" target="'. $target .'"></a>';
						}
						...
						<?php if( $repeater_item->title !== '' ) : ?>
							<?php if ( $repeater_item->link !== '' ) : ?>
								<h2 class="slider-title">
									<a title="Article" href="<?php echo esc_url( $repeater_item->link ); ?>"><?php echo $repeater_item->title; ?></a>	
								</h2>
							<?php else: ?>
						...
						<div class="slider-read-more">
							<a title="En Savoir Plus" href="<?php echo esc_url( $repeater_item->link ); ?>" target="<?php echo $target; ?>"><?php echo $repeater_item->btn_text; ?></a>
						</div>
						<?php endif; ?>
